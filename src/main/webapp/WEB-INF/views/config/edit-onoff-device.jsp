...
<section class="no-padding-top">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="block">
                    <div class="title"><strong>Wprowadź zmienione dane urządzenia ${editingDevice.name}</strong></div>
                    <div class="block-body">
                        <form:form modelAttribute="editingDevice" method="post" action="${pageContext.request.contextPath}/config/edit/1/${editingDevice.id}" class="form-horizontal">
